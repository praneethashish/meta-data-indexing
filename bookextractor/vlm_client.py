...
class VLMClient:
    ...
    def __init__(self, model_id: str | None = None):
        raise NotImplementedError(
            "Image VLM description is not yet implemented. Only EXIF metadata extraction is available for images."
        )

    async def describe_image(self, image_path: str) -> dict:
        """Generate description for an image using Gemma-4 vLLM."""
        raise NotImplementedError("Image VLM description is not yet implemented.")
